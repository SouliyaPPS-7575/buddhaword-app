...
//     if (_videoLink != null) {
//       final videoId = YoutubePlayer.convertUrlToId(_videoLink!);
//       if (videoId != null) {
...
//       // Resume the video when the app comes to the foreground
...
//       final videoId = YoutubePlayer.convertUrlToId(videoYoutubeLink);
//       if (videoId != null) {
...
//       if (isYouTube) {
//         final videoId = YoutubePlayer.convertUrlToId(videoLinks.trim());
...
//                     Flexible(
//                       fit: FlexFit
//                           .loose, // Use FlexFit.loose to allow flexible children to size themselves to less space
...
//                             children: [
//                               player,
//                               // Additional widgets or your video list can be added here
//                               Expanded(
